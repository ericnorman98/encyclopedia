...
:results:
#+SETUPFILE: setup.org
#+PROPERTY: header-args:jupyter-python :exports results :session ricker_map :results raw :eval no-export :pandoc t :async yes :tangle ricker_map.py
...
#+BEGIN_SRC jupyter-python :noweb yes :var name=doc-name :results output :exports none
plt.figure(figsize=(4, 4))
N0_n = 900
alpha_n = 0.01
Rs_n = np.arange(1.0, 30.0, 0.1)
