...
:results:
#+SETUPFILE: setup.org
#+PROPERTY: header-args:jupyter-python :exports results :session graphs_and_networks :results raw :eval no-export :pandoc t :async yes :tangle small_world_network.py
...
#+begin_src jupyter-python :results output :noweb yes :exports none :var name=doc-name
n = 64
c1 = 16
p1 = 0
c2 = 16
