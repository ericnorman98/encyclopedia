...
:results:
#+SETUPFILE: setup.org
#+PROPERTY: header-args:jupyter-python :exports results :session linear_least_squares :results raw :eval no-export :pandoc t :async yes :tangle linear_least_squares.py
...
#+name: src:fig:points
#+begin_src jupyter-python :results output :var name=doc-name :noweb yes
...
#+begin_src jupyter-python :exports none :var name=doc-name
plt.figure(figsize=(2, 2))
plt.axis('off')
plot_with_errors(b0_n=b0hf_lam(xs, ys, V[n]),
            b1_n=b1hf_lam(xs, ys, V[n]))
