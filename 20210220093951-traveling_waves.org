...
:results:
#+SETUPFILE: setup.org
#+PROPERTY: header-args:jupyter-python :exports results :session traveling_waves :results raw :eval no-export :pandoc t :async yes :tangle traveling_waves.py
...
LImply(LValues(dims), LValues(dimless_subs))
#+end_src
...
[[file:./.ob-jupyter/d88346f9543b744e56da26a138c2940ba8f0b434.png]]
...
#+begin_src jupyter-python :results output :var name=doc-name :exports none
plt.figure(figsize=(4, 4))
...
#+RESULTS:
[[file:./.ob-jupyter/59da31cc3820c6e7d58ac85dc26cf77dac928f62.png]]
...
[[file:./.ob-jupyter/28a23eb2389a55fac12bb6b838a327cb1f8b847f.png]]
...
[[file:./.ob-jupyter/7f6ca9faf45fac80c24cbad21f14c830c97b5cbe.png]]
...
[[file:./.ob-jupyter/718e60a0725062df020a0277ea5f8b893717a09a.png]]
...
[[file:./.ob-jupyter/3650e3983428e3da1a74eeb7b30637b803b0be3d.png]]
...
[[file:./.ob-jupyter/9a4c3c1d02cad819702c4031e626096501371388.png]]
...
[[file:./.ob-jupyter/89c18493dad85a157ccc6d1d6ce53dbb10f17dfe.png]]

# ** COMMENT Animation
# #+begin_src jupyter-python :results output
# xi_n = np.arange(V[L])
# dt = 0.05
# t_n = np.arange(0, 20, dt)
# fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(8, 4))
# ax1.set_xlim([0, V[L]])
# ax1.set_ylim([0, 6])
# ax2.set_ylim([0, 6])
...
# [[file:./.ob-jupyter/d15250954c39cd4e575788556239ca18def6b360.png]]
# :END:
...
[[file:./.ob-jupyter/82ef0067577927bfcff41a053f7d4a93b5504e36.png]]
...
[[file:./.ob-jupyter/d426add3dfa5f17b1f783648279120c812725baa.png]]
...
[[file:./.ob-jupyter/8f19b5a12a04906aba50034657f8f0b62e2f1b38.png]]
