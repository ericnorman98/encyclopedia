...
:results:
#+SETUPFILE: setup.org
#+PROPERTY: header-args:jupyter-python :exports results :session tree_fractal :results raw :eval no-export :pandoc t :async yes :tangle tree_fractal.py
...
#+begin_src jupyter-python :exports none :results silent :noweb yes
w = h = 400
...
#+begin_src jupyter-python :exports none :results output :noweb yes :var name=doc-name
plt.figure()
lines = []
