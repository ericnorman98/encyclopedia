...
:results:
#+SETUPFILE: setup.org
#+PROPERTY: header-args:jupyter-python :exports results :session diffusion_driven_instability :results raw :eval no-export :pandoc t :async yes :tangle diffusion_driven_instability.py
...
#+RESULTS:
[[file:./.ob-jupyter/649f0855c1c1bcf5411ecade85ab624a4964f65d.png]]
...
[[file:./.ob-jupyter/61217705257e6ea9cc4a57b0014ff805634ca9c3.png]]
...
# #+begin_src jupyter-python
# UV = get_initial_state()
# t_n = np.arange(0, 10, 0.01)
# dt = 0.1
# T = 50
# r = ode(model_ode).set_integrator('vode')
# r.set_initial_value(UV.flatten(), 0).set_f_params(9)
# steps = int(T/dt)
# norm = lambda x: (x-x.min())/(x.max()-x.min())
# plt.imshow(norm(sol[:, :, 0]))
# #+end_src

# #+RESULTS:
# :RESULTS:
# : <matplotlib.image.AxesImage at 0x7f1000803970>
# [[file:./.ob-jupyter/32300d1a09555e51b2e567b2d7ac96acfd287f44.png]]
# :END:
